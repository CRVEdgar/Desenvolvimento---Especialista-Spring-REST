...
--     )
--
--     alter table if exists tab_cidade
--        add constraint FK4b6sgc0n0yyygn88op23j2bu
--        foreign key (estado_id)
--        references tab_estado
--
--     alter table if exists tab_produto
--        add constraint FKgn65t4mb2y55y6h41of9hnbbh
--        foreign key (restaurante_id)
--        references tab_restaurante
--
--     alter table if exists tab_restaurante
--        add constraint FKcnq3om0d9yueqhlo1955r3x69
--        foreign key (cozinha_id)
--        references tab_cozinhas
--
--     alter table if exists tab_restaurante
--        add constraint FKc38xcl49t59w9utt67nucwiq3
--        foreign key (endereco_cidade_id)
--        references tab_cidade
--
--     alter table if exists tbl_grupo_permissoes
--        add constraint FKjh82y5c9l94xw291sga075t2k
--        foreign key (permisoes_id)
--        references tab_permissao
--
--     alter table if exists tbl_grupo_permissoes
--        add constraint FK1uvx271nvq7fgye24j3s0qpx4
--        foreign key (grupo_id)
--        references tab_grupos
--
--     alter table if exists tbl_restaurante_forma_pagamento
--        add constraint FK7vcfauyxv0t5qhmwqnallejn0
--        foreign key (forma_pagamento_id)
--        references tab_forma_pagamento
--
--     alter table if exists tbl_restaurante_forma_pagamento
--        add constraint FK9ts3jqreupj8mggjjhl5vrtx3
--        foreign key (restaurante_id)
--        references tab_restaurante
--
--     alter table if exists tbl_usuario_grupo
--        add constraint FK7haghqy7ge4m3vom149p125xc
--        foreign key (grupos_id)
--        references tab_grupos
--
--     alter table if exists tbl_usuario_grupo
--        add constraint FKgg5uluyta2pd3srvmh5cwsr31
--        foreign key (usuario_id)
--        references tab_usuarios
--
-- --
